...
def unlink():
    ...
    if user.discord_id:
        ...
        # The Trainlog channel's auto-posting needs the id to post under, so
        # unlinking withdraws consent to it as well — otherwise the flag lingers
        # and quietly resumes if the account is ever relinked.
